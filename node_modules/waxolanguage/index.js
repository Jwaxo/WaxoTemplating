...
function Parser(tags) {
	...
	//This saves given tags to an object, so they can be checked and called
			...
			if (parsedFunction != null) {
				if (possibleFunction[0] == 'end' + searchedEnd) {
					...
					if (hasEnd != null && hasEnd != undefined) {
						...
						string = this.replaceInto(funcChopBit.index, endParsed.endpoint + funcChopBit[0].length, parsedString, string);
	...
	this.searchSpecific = function(string, searched) {
